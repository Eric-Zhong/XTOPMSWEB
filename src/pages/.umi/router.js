...
let routes = [
  {
    ...
    component: dynamic({
      ...
      loading: require("/Work/Dotnet/XTOPMSWEB/src/components/PageLoading/index")
        .default
    }),
    routes: [
      {
      ...
      },
      {
        component: () =>
          React.createElement(
            require("/Work/Dotnet/XTOPMSWEB/node_modules/.1.2.5@umi-build-dev/lib/plugins/404/NotFound.js")
              .default,
