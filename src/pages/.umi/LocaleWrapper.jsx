...
const localeInfo = {
  'en-US': {
    messages: {
      ...require('/Work/Projects/XTO/web/src/locales/en-US.js').default,
    },
    locale: 'en-US',
  ...
  'pt-BR': {
    messages: {
      ...require('/Work/Projects/XTO/web/src/locales/pt-BR.js').default,
    },
    locale: 'pt-BR',
  ...
  'zh-CN': {
    messages: {
      ...require('/Work/Projects/XTO/web/src/locales/zh-CN.js').default,
    },
    locale: 'zh-CN',
  ...
  'zh-TW': {
    messages: {
      ...require('/Work/Projects/XTO/web/src/locales/zh-TW.js').default,
    },
    locale: 'zh-TW',
